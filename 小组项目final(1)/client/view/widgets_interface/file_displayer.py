...
class ListItems(Frame):
	def __init__(self,master,textlist):
		...
		self.config(width =1000,height=50,bg='#FFFFFF',highlightbackground='#CCCCCC',highlightthickness=1)
	...
	def create_labels(self):
		self.labels.append(Label(self,text=self.textlist[0],anchor=W,bg='#FFFFFF',width=15))
		self.labels.append(Label(self,text=self.textlist[1],anchor=W,bg='#FFFFFF',width=5))
		self.labels.append(Label(self,text=self.textlist[2],anchor=W,bg='#FFFFFF',width=40))
