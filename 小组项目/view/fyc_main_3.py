...
def main():
    ...
    #搜索框被标签页叠了，我还没处理，明天再看看
    e=Myentry(root)
    e.place(relx=0.43, rely=0.03, relwidth=0.528, relheight=0.05)
    ...
    lb4 = Listbox(root)
    lb4.place(relx=0.37, rely=0.65, relwidth=0.174, relheight=0.337)    
    ...
    #  各种按钮     等你们的接口~
    b_upload = Mybutton(root, hello, text='浏览 (L)')

    b_upload.place(relx=0.274, rely=0.666, relwidth=0.06, relheight=0.045)
